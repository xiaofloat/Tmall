# -*- coding: utf-8 -*-
# Generated by Django 1.11.12 on 2018-07-23 21:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='User',
            fields=[
                ('last_login', models.DateTimeField(auto_created=True, verbose_name='最后一次登录')),
                ...
                ('create_date', models.DateTimeField(auto_now_add=True, max_length=1, verbose_name='创建时间')),
                ('status', models.IntegerField(choices=[(1, '正常'), (2, '禁止')], verbose_name='状态')),
            ],
            options={
                'verbose_name': '用户管理',
        ...
        migrations.AddField(
            model_name='shopcar',
            name='user',
            field=models.ForeignKey(db_column='uid', on_delete=django.db.models.deletion.DO_NOTHING, to='home.User', verbose_name='用户ID'),
        ),
        migrations.AddField(
            model_name='review',
            name='shop',
